...
public enum ErrorCodes {
        ...
        ERROR_IN_GET_USER(1004,"Error Occured to get an User"),
        ERROR_IN_PUT_USER(1005,"Error Occured to put a User"),
        ERROR_IN_PUT_USERS(1006,"Error Occured to put List of Users");
